        ...
        try {
            if (this.adapter.config.ClimateConfig) {
                for (const config of this.adapter.config.ClimateConfig) {
                    ...
                    const Id = climateUniqueString?.flat + this.EndingVirtualCover; // geändert 12.01.2026 config.climateIds.target.substring(0, indexLastDotTarget) + this.EndingVirtualClimate;
    ...
    */
    ...
    async discoverForeignHumidifier(config) {
        ...
        try {
            ...
            const Id = humidifierUniqueString?.flat + this.EndingVirtualCover; // geändert 12.01.2026 config.HumidifierIds.onOff.substring(0, indexLastDotOnOff) + this.EndingVirtualHumidifier;
    ...
    async discoverForeignLight(config) {
        ...
        try {
            ...
            const Id = lightUniqueString?.flat + this.EndingVirtualCover; // geändert 12.01.2026 config.LightIds.onOff.substring(0, indexLastDotOnOff) + this.EndingVirtualLight;
    ...
    async discoverForeignLock(config) {
        ...
        try {
            ...
            const Id = lockUniqueString?.flat + this.EndingVirtualCover; // geändert 12.01.2026 generalId.substring(0, indexLastDotOnOff) + this.EndingVirtualLock;
