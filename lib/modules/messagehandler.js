            ...
            for (const adapterObject of Object.values(adapterObjectsAtStart)) {
                if (adapterObject.type === 'state') {
                    ...
                    if (
                        ...
                        // 16.08.2025 => HA Bridge
                        const myObject = await this.adapter.getObjectAsync(adapterObject._id);
                        await this.directoryhandler.setCustomForHaBridge(adapterObject._id, myObject.common);
                        await this.adapter.extendObjectAsync(adapterObject._id, {
                            type: 'state',
                    ...
                    for (const downlinkParameter of Object.values(
                        ...
                        if (downlinkDevice.length > foundLength[downlinkParameter.name]) {
                            ...
                            */
                            ...
                            await this.directoryhandler.setCustomForHaBridge(stateId, common);
