...
class toIobDevicesClass {
    ...
    async getDeviceDetails(id) {
        ...
        this.adapter.log.warn(JSON.stringify(this.extractStateObjects(this.adapter.objectStore.toIob.devices[id])));
        for (const [key, value] of Object.entries(
            this.extractStateObjects(this.adapter.objectStore.toIob.devices[id]),
        )) {
