...
class assignhandlerClass {
        ...
        this.assign = {
            ...
            MotorCalibration: {
                approvedFolders: {
                    'downlink.control': {
                        assignfunction: this.commonAssign,
                        common: {
                            role: 'button.mode.startMotorcalibration',
                        },
                    },
                },
            },
            ...
            TargetTemperature: {
                approvedFolders: {
                    ...
                    'uplink.decoded.HeatingEvents.0': {
                        assignfunction: this.commonAssign,
                        common: {
                            unit: '°C',
                        },
                    },
                    'uplink.decoded.HeatingEvents.1': {
                        assignfunction: this.commonAssign,
                        common: {
                            unit: '°C',
                        },
                    },
                    'uplink.decoded.HeatingEvents.2': {
                        assignfunction: this.commonAssign,
                        common: {
                            unit: '°C',
                        },
                    },
                    'uplink.decoded.HeatingEvents.3': {
                        assignfunction: this.commonAssign,
                        common: {
                            unit: '°C',
                        },
                    },
                    'uplink.decoded.HeatingEvents.4': {
                        assignfunction: this.commonAssign,
                        common: {
                            unit: '°C',
                        },
                    },
                    'uplink.decoded.HeatingEvents.5': {
                        assignfunction: this.commonAssign,
                        common: {
                            unit: '°C',
                        },
                    },
                    'uplink.decoded.HeatingEvents.6': {
                        assignfunction: this.commonAssign,
                        common: {
                            unit: '°C',
                        },
                    },
                    'uplink.decoded.HeatingEvents.7': {
                        assignfunction: this.commonAssign,
                        common: {
                            unit: '°C',
                        },
    ...
    getAssign(statename) {
        ...
        return assignKey ? this.assign[assignKey] : undefined;
    }
