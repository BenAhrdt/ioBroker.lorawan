    ...
    constructor(adapter) {
        ...
        this.bridge = {
            ...
            roleAssignToDeviceInformations: {
                ...
                'value.temperature': [{ name: 'valueTemperature' }],
                'value.humidity': [{ name: 'valueHumidity' }],
                'sensor.window': [{ name: 'sensorWindow' }],
                'sensor.door': [{ name: 'sensorDoor' }],
                'sensor.contact': [{ name: 'sensorContact' }],
            },
            assignToDeviceInformations: {
                AbsoluteHumidity: [{ name: 'absoluteHumidity' }],
                angle: [{ name: 'angle' }],
